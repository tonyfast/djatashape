...
class DjataShape
  ...
  structure =  _ '{' _ entries:structure_entries? entry:(structure_entry) _ '}' _ {
  ...
  structure_entry = key:(string/literal_string) _ ':' _ value:datashape { return { key: key, value: value,}; }
  ...
  compound_entry = key:(string/literal_string) _ '=' _ value:(literal_string/types/list) { return { key: key, value: value,};  } /
